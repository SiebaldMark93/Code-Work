...
const API_KEY = 'cb4bf06d2d3612300cf8ec0b12f5e675';

const days = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'];
const months = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
//set interval function is a function that can can be called after a particular interval and will go continuously until the interval is clear.
